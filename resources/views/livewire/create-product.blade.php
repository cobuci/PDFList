<div>
    ...
    <x-dialog id="productDialog" title="Adicionar Produto a lista {{ $product['group_id'] }}">
        ...
        <x-inputs.number label="Lote minimo" placeholder="Insira o lote minimo" wire:model="product.min_amount"/>
